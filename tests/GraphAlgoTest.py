...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_graph(self):
        self.graphAlgo = setUp1()
        self.assertEqual(20, self.graphAlgo.get_graph().v_size())
        self.assertEqual(19, self.graphAlgo.get_graph().e_size())

    def test_sava_and_load(self):
        file_path1 = '../data/A0'
        file_path2 = '../data/A1'
        file_path3 = '../data/A2'
        file_path4 = '../data/A3'
